...
using UniversityCodeFirts;
using UniversityCodeFirts.Models;

namespace UniversityCodeFirts.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        {
            var officeAssignments = db.OfficeAssignments.Where(x => x.Enabled == true).Include(o => o.Instructor);
